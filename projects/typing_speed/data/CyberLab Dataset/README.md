...
If you can, you can also cite the [latest version of this dataset on Zenodo](https://zenodo.org/record/8136017):

```
@misc{Svabensky2023dataset,
    author    = {\v{S}v\'{a}bensk\'{y}, Valdemar and Vykopal, Jan and Seda, Pavel and \v{C}eleda, Pavel},
    title     = {{Dataset: Shell Commands Used by Participants of Hands-on Cybersecurity Training}},
    year      = {2023},
    publisher = {Zenodo},
    doi       = {10.5281/zenodo.8136017},
    url       = {https://zenodo.org/record/8136017}
}
```
